...
(async () => {
  ...
  // ===== G. 静态源码断言 =====
  {
    ...
    log('G8 CURRENT_VERSION=2.21.7', /CURRENT_VERSION = '2\.21\.7'/.test(html));
    log('G9 changelog 含 2.21.7 条目', /version: '2\.21\.7'/.test(html));
    log('G10 SW 缓存 v63', /food-inventory-v63/.test(sw));
