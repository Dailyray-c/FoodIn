...
(async () => {
  ...
  // ===== G. 静态源码断言 =====
  {
    ...
    log('G8 CURRENT_VERSION=2.21.6', /CURRENT_VERSION = '2\.21\.6'/.test(html));
    log('G9 changelog 含 2.21.6 条目', /version: '2\.21\.6'/.test(html));
    log('G10 SW 缓存 v62', /food-inventory-v62/.test(sw));
