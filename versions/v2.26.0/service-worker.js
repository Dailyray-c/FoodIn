const CACHE_NAME = 'food-inventory-v96';   // v2.26.0：架构重构（废弃 locations 池 / tags 转换收敛 / removeProduct 统一删除 / 设置同步 schema 驱动 / 清理 ServerChan 死代码）。递增 → 旧 SW 失效，activate 时删除旧缓存
